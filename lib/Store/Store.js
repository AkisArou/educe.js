...
var Store = /** @class */ (function () {
    ...
    Store.prototype.previousState = function (prop) {
        ...
        var _a;
        this.onHistoryChangeCommit((_a = this.history) === null || _a === void 0 ? void 0 : _a.previousState(prop));
    };
    ;
    Store.prototype.nextState = function (prop) {
        if (prop === void 0) { prop = ENTIRE_STATE_1.ENTIRE_STATE; }
        var _a;
        this.onHistoryChangeCommit((_a = this.history) === null || _a === void 0 ? void 0 : _a.nextState(prop));
    };
    Store.prototype.stateAt = function (idx, prop) {
        if (prop === void 0) { prop = ENTIRE_STATE_1.ENTIRE_STATE; }
        var _a;
        this.onHistoryChangeCommit((_a = this.history) === null || _a === void 0 ? void 0 : _a.stateAt(idx, prop));
    };
