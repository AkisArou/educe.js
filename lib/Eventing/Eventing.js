...
var ENTIRE_STORE_LISTENERS_1 = require("./ENTIRE_STORE_LISTENERS");
var Eventing = /** @class */ (function () {
    function Eventing() {
        ...
        this.trigger = function (prop, data) {
            ...
            (_b = _this.stateSetters[ENTIRE_STORE_LISTENERS_1.ENTIRE_STORE_LISTENERS]) === null || _b === void 0 ? void 0 : _b.forEach(function (ln) { return ln(data); });
        };
    }
    return Eventing;
}());
